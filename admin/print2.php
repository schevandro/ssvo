...
if (empty($_GET['id']) || $_GET['id'] <= 0) {
    header('Location: admin_esolicitacoes.php?solit=aberto');
} else {
    ?>
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
            ...
            <link href="../_assets/css/prints/print-viaturas.css" rel="stylesheet" type="text/css" />
...
//Busca Servidor
            ...
            $readSelecionada = read('vt_solicitacoes', "WHERE id = '$solicitacao_verificada' AND situacao = '$solicitacao_situacao' AND data_uso >= '$hoje'");
    ...
    if ($countReadSelecionada <= 0) {
        ?>
                ...
                <div id="guia_nAutorizada">
                    <h3>ERRO: Esta guia não pode ser impressa. Contate o administrador do sistema.</h3>
        ...
        <?php echo date('d/m/y', strtotime($guia['prev_retorno_data'])) . ' às ' . date('H:i', strtotime($guia['prev_retorno_hora'])); ?>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr class="dados">
                            ...
                            <td align="center"><?php //echo $guia['km_saida'];  ?></td>
                            <td align="center">&nbsp;</td>
                            <td align="center">&nbsp;</td>
                            <td align="center">&nbsp;</td>  
                        </tr>
