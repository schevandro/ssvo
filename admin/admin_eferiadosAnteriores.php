...
if ($_SESSION['autUser']['admin'] == 1 || $_SESSION['autUser']['admin'] == 3):
    ...
    $sql_busca  = read('feriados',"WHERE ano != {$este_ano} ORDER BY ano DESC LIMIT {$inicio},{$maximo}");
    $sql_conta  = read('feriados',"WHERE ano != {$este_ano}");
    $num        = count($sql_conta);
?>
      
    <h1 class="titulo-secao"><i class="fa fa-calendar-times-o"></i> Feriados de anos anteriores <span><?php echo $num; ?> registros</span></h1>    
    ...
    <a href="admin_eferiados.php" class="btn btn_orange fl_right" title="Feriados do ano corrente"><i class="fa fa-calendar-times-o"></i> FERIADOS DO ANO CORRENTE</a>
...
<?php
    ...
    if (isset($_GET['id_feriado'])):
        ...
        if($sql_deleta):
            ...
            header("Refresh: 2; url=admin_eferiadosAnteriores.php");
        else:
...
?>      
	...
	?>
        <tr <?php echo $cor; ?> class="lista_itens">
            ...
            <td align="center"><a href="admin_eferiadosAnteriores.php?id_feriado=<?php echo $exibeId; ?>" style="text-decoration:none; color:#033; font-size: 1.7em;" title="Deletar setor"><i class="fa fa-trash-o"></i></a></td>
        </tr>
        <?php
            endforeach;
        ?>
    ...
    <div id="paginator">
        <?php
            ...
            echo "<a href=admin_eferiadosAnteriores.php?pag=1>Primeira</a>&nbsp;&nbsp;&nbsp;";

            for ($i = $pag-$links; $i <= $pag-1; $i++):
                if ($i <= 0):
                else:
                    echo"<a href=admin_eferiadosAnteriores.php?pag=$i>$i</a>&nbsp;&nbsp;&nbsp;";
                endif;
            endfor;
            echo "<h1>$pag</h1>";
            ...
            echo "<a href=admin_eferiadosAnteriores.php?pag=$paginas>Última</a>&nbsp;&nbsp;&nbsp;";
        ?>
    </div>
