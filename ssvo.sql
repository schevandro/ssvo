...
--
-- Host: localhost
-- Generation Time: 26-Maio-2017 às 15:09
...
CREATE TABLE `cargahoraria` (
  `id` int(11) NOT NULL,
  `carga_horaria` char(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `cargahoraria` (`id`, `carga_horaria`) VALUES
(1, '20'),
(2, '25'),
(3, '30'),
(4, '40'),
...
INSERT INTO `funcoes` (`id`, `funcao`, `abreviatura`) VALUES
(1, 'Professor EBTT', 'P. EBTT'),
(2, 'Tecnico Administrativo', 'TA'),
(3, 'Tecnico em Assuntos Educacionais', 'TAE'),
(4, 'Estagiários', 'ESTAG'),
(5, 'Terceirizados', 'TERCER');
...
INSERT INTO `lotacao` (`id`, `campus`, `abreviatura`) VALUES
(1, 'Bento Goncalves', 'BGO'),
(2, 'Canoas', 'CAN'),
(3, 'Caxias do Sul', 'CAX'),
(4, 'Erechim', 'ERE'),
(5, 'Feliz', 'FLZ'),
...
CREATE TABLE `servidores` (
  ...
  `senha` varchar(255) NOT NULL DEFAULT '25d55ad283aa400af464c76d713c07ad',
  `code` varchar(255) NOT NULL DEFAULT '12345678',
  `mudarsenha` int(1) NOT NULL,
  `setor` varchar(255) NOT NULL,
  `foto` varchar(255) NOT NULL,
  `lotacao` varchar(50) NOT NULL,
  `funcao` varchar(255) NOT NULL,
  `admin` int(11) NOT NULL DEFAULT '9',
  `carga_horaria` char(2) NOT NULL,
  ...
  `os_motorista` varchar(10) NOT NULL DEFAULT 'n',
  `os_motorista_data` date NOT NULL DEFAULT '0000-00-00',
  `os_digitalizada` varchar(255) NOT NULL,
  ...
  `fone_outro` varchar(14) NOT NULL,
  `chave` varchar(255) NOT NULL,
  `ativo` int(1) NOT NULL DEFAULT '1',
  `cod_abastecimento` int(10) DEFAULT '0',
  `pass_abastecimento` varchar(10) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `servidores` (`id`, `criadoEm`, `modificadoEm`, `nome`, `siape`, `senha`, `code`, `mudarsenha`, `setor`, `foto`, `lotacao`, `funcao`, `admin`, `carga_horaria`, `email`, `nascimento`, `sexo`, `cpf`, `estado`, `cnh`, `cnh_categoria`, `cnh_vencimento`, `os_motorista`, `os_motorista_data`, `os_digitalizada`, `end_rua`, `end_num`, `end_bairro`, `end_complemento`, `end_cidade`, `end_cep`, `fone_celular`, `fone_outro`, `chave`, `ativo`, `cod_abastecimento`, `pass_abastecimento`) VALUES
(1, '2016-10-04 03:00:00', '2017-05-26 18:09:03', 'Admin', '1234567', '25d55ad283aa400af464c76d713c07ad', '12345678', 0, 'TI', 'usuario_sem_foto.png', 'Feliz-RS', 'TA', 1, '40', 'dti@feliz.ifrs.edu.br', '2016-05-26', 'Masculino', '12345678900', '', '', '', '0000-00-00', 'n', '0000-00-00', '', 'Rua do EndereÃ§o', 1, 'Bairro', 'NÃ£o', 'Feliz-RS', '00000000', '54 00000000', '', '', 1, 0, '0');
...
--
-- Estrutura da tabela `vt_caronas`
--

CREATE TABLE `vt_caronas` (
  `id` int(11) NOT NULL,
  `solicitadaEm` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `servidor` varchar(255) DEFAULT NULL,
  `siape` int(7) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
  `guia_carona` int(10) DEFAULT NULL,
...
--
-- Estrutura da tabela `vt_manutencao`
--

CREATE TABLE `vt_manutencao` (
  `id` int(11) NOT NULL,
  `criada_em` timestamp NULL DEFAULT NULL,
  `data` date DEFAULT NULL,
  `empresa` varchar(255) DEFAULT NULL,
  `veiculo` int(11) DEFAULT NULL,
  `km_revisao` int(10) DEFAULT NULL,
  `servidor` int(11) DEFAULT NULL,
  `oleo` int(1) DEFAULT NULL,
  `correa` int(1) DEFAULT NULL,
  `geometria` int(1) DEFAULT NULL,
  `revisao` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `vt_motivos`
--

CREATE TABLE `vt_motivos` (
  `id` int(11) NOT NULL,
  `motivo` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `vt_motivos`
--

INSERT INTO `vt_motivos` (`id`, `motivo`) VALUES
(1, 'Veiculos ocupados para esta data'),
(2, 'Veiculos em manutenção'),
(3, 'Veiculos sem combustível');

-- --------------------------------------------------------

--
-- Estrutura da tabela `vt_situacoes`
--

CREATE TABLE `vt_situacoes` (
  `id` int(11) NOT NULL,
  `situacao` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `vt_situacoes`
--

INSERT INTO `vt_situacoes` (`id`, `situacao`) VALUES
(1, 'Aguardando...'),
(2, 'Autorizada'),
(3, 'Nao Autorizada'),
(4, 'Cancelada'),
...
--
-- Estrutura da tabela `vt_situacoes_viaturas`
--

CREATE TABLE `vt_situacoes_viaturas` (
  `id` int(11) NOT NULL,
  `situacao` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `vt_situacoes_viaturas`
--

INSERT INTO `vt_situacoes_viaturas` (`id`, `situacao`) VALUES
(1, 'Sem Seguro'),
(2, 'Em Manutenção'),
(3, 'Em Revisão'),
(4, 'Aguardando Documentação'),
(5, 'Ocupada'),
(6, 'Liberada');
...
--
-- Estrutura da tabela `vt_solicitacoes`
--

CREATE TABLE `vt_solicitacoes` (
  `id` int(11) NOT NULL,
  `criadoEm` timestamp NULL DEFAULT NULL,
  `modificadoEm` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `servidor` varchar(255) DEFAULT NULL,
  ...
  `siape_motorista` varchar(10) DEFAULT NULL,
  `email_motorista` varchar(255) DEFAULT NULL,
  `cnh_motorista` varchar(12) DEFAULT NULL,
  `cnh_vencimento` date DEFAULT NULL,
  `cnh_categoria` char(2) DEFAULT NULL,
  `os_motorista` varchar(10) DEFAULT NULL,
  `os_motorista_data` date DEFAULT NULL,
  `finalidade` varchar(255) DEFAULT NULL,
  `desc_finalidade` longtext,
  `roteiro` varchar(255) DEFAULT NULL,
  `roteiro_2` varchar(255) DEFAULT NULL,
  `roteiro_3` varchar(255) DEFAULT NULL,
  `data_uso` date DEFAULT NULL,
  `horario_uso` time DEFAULT NULL,
  `prev_retorno_data` date DEFAULT NULL,
  `prev_retorno_hora` time DEFAULT NULL,
  `passageiros` longtext,
  `caronas` int(1) DEFAULT '0',
  `situacao` varchar(255) DEFAULT 'Aguardando...',
  `veiculo` varchar(255) DEFAULT 'n/d',
  `motivo` longtext,
  `km_saida` varchar(255) DEFAULT '0',
  `km_chegada` varchar(255) DEFAULT '0',
  `km_percorridos` varchar(255) DEFAULT '0',
  `data_chegada` date DEFAULT NULL,
  `hora_chegada` time DEFAULT NULL,
  `observacao` longtext,
  `siape_aceitador` int(7) DEFAULT '0',
  `datetime_saida` datetime NOT NULL,
  `datetime_retorno` datetime NOT NULL,
  `chave_solicitacao` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estrutura da tabela `vt_veiculos`
--

CREATE TABLE `vt_veiculos` (
  `id` int(11) NOT NULL,
  `atualizadoEm` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  ...
  `ipva` date DEFAULT NULL,
  `seguro` date NOT NULL,
  `doc_veiculo` varchar(255) NOT NULL,
  `km` varchar(255) DEFAULT NULL,
  `combustivel` char(1) DEFAULT NULL,
  `troca_oleo` varchar(255) DEFAULT NULL,
  `revisao` int(6) DEFAULT NULL,
  `geometria` varchar(255) NOT NULL,
  `correa` varchar(255) NOT NULL,
  `situacao` varchar(255) DEFAULT NULL,
  `ativo` char(1) DEFAULT '1',
  `ultima_solicit` int(11) DEFAULT NULL,
...
--
-- Indexes for table `cargahoraria`
--
...
--
-- Indexes for table `vt_caronas`
--
ALTER TABLE `vt_caronas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vt_manutencao`
--
ALTER TABLE `vt_manutencao`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vt_motivos`
--
ALTER TABLE `vt_motivos`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vt_situacoes`
--
ALTER TABLE `vt_situacoes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vt_situacoes_viaturas`
--
ALTER TABLE `vt_situacoes_viaturas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vt_solicitacoes`
--
ALTER TABLE `vt_solicitacoes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `vt_veiculos`
--
ALTER TABLE `vt_veiculos`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cargahoraria`
--
ALTER TABLE `cargahoraria`
...
ALTER TABLE `setores`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `vt_caronas`
--
ALTER TABLE `vt_caronas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `vt_manutencao`
--
ALTER TABLE `vt_manutencao`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `vt_motivos`
--
ALTER TABLE `vt_motivos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `vt_situacoes`
--
ALTER TABLE `vt_situacoes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `vt_situacoes_viaturas`
--
ALTER TABLE `vt_situacoes_viaturas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `vt_solicitacoes`
--
ALTER TABLE `vt_solicitacoes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `vt_veiculos`
--
ALTER TABLE `vt_veiculos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
